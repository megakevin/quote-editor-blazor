...
namespace QuoteEditorBlazor.Migrations
{
    ...
    [Migration("20221020213242_CreateLineItems")]
    partial class CreateLineItems
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuoteEditorBlazor.Models.LineItem", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("LineItemDateID")
                        .HasColumnType("integer")
                        .HasColumnName("line_item_date_id");
                    ...
                    b.HasIndex("LineItemDateID")
                        .HasDatabaseName("ix_line_items_line_item_date_id");
            ...
            modelBuilder.Entity("QuoteEditorBlazor.Models.LineItem", b =>
                {
                    b.HasOne("QuoteEditorBlazor.Models.LineItemDate", "LineItemDate")
                        .WithMany("LineItems")
                        .HasForeignKey("LineItemDateID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_line_items_line_item_dates_line_item_date_id");

                    b.Navigation("LineItemDate");
                });
